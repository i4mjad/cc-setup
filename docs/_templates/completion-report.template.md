...
> One shared file. Each build agent edits **only its own section** (Web=@frontend, iOS=@ios,
> Flutter=@flutter, Backend=@backend). Do not touch another agent's section. Only sections for the
> platforms actually in play (CLAUDE.md §5) get filled — leave the rest as "n/a".
...
- **What was built:** <summary>
- **AC covered:** <story/scenario → where it's satisfied>
- **How to run / preview:** <scheme / simulator steps qa-tester will use>
- **Integration notes for backend:** <contracts consumed, expectations>
...
- **What was built:** <summary>
- **AC covered:** <story/scenario → where it's satisfied>
- **How to run / preview:** <flavor / device steps qa-tester will use>
- **Integration notes for backend:** <contracts consumed, expectations>
