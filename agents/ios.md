...
4. Fill **only the iOS section** of `docs/reports/<slug>/completion-report.md` (create it from
...
## Definition of done
Every `owner: ios` task's AC is satisfiable in the running app; the iOS report section is complete with
run/preview steps; no scope creep, no unnecessary complexity; localization honored.
